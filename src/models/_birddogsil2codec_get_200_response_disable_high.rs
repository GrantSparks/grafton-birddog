...
pub struct Birddogsil2codecGet200ResponseDisableHigh {
...
impl Birddogsil2codecGet200ResponseDisableHigh {
    pub fn new() -> Birddogsil2codecGet200ResponseDisableHigh {
        Birddogsil2codecGet200ResponseDisableHigh {
            bitrate: None,
            gop_size: None,
            quant_factor_i: None,
            quant_factor_p: None,
