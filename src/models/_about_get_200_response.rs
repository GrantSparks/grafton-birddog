...
pub struct AboutGet200Response {
    ...
    #[serde(rename = "NetworkConfigMethod", skip_serializing_if = "Option::is_none")]
...
impl AboutGet200Response {
    pub fn new() -> AboutGet200Response {
        AboutGet200Response {
