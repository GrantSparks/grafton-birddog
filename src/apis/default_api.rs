...
pub async fn about_get(configuration: &configuration::Configuration, firmware_version: Option<&str>) -> Result<(), Error<AboutGetError>> {
...
pub async fn analogaudiosetup_get(configuration: &configuration::Configuration, analog_audio_in_gain: Option<&str>, analog_audio_out_gain: Option<&str>, analog_audiooutputselect: Option<&str>) -> Result<(), Error<AnalogaudiosetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn analogaudiosetup_post(configuration: &configuration::Configuration, analogaudiosetup_post_request: models::AnalogaudiosetupPostRequest) -> Result<(), Error<AnalogaudiosetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogadvancesetup_get(configuration: &configuration::Configuration, brightness: Option<&str>, brightness_comp: Option<&str>, comp_level: Option<&str>, gamma_offset: Option<&str>, high_resolution: Option<&str>, video_enhancement: Option<&str>) -> Result<(), Error<BirddogadvancesetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogadvancesetup_post(configuration: &configuration::Configuration, birddogadvancesetup_post_request: models::BirddogadvancesetupPostRequest) -> Result<(), Error<BirddogadvancesetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogcmsetup_get(configuration: &configuration::Configuration, blue_gain: Option<&str>, blue_hue: Option<&str>, colour_gain: Option<&str>, cyan_gain: Option<&str>, cyan_hue: Option<&str>, green_gain: Option<&str>, green_hue: Option<&str>, hue_phase: Option<&str>, mag_gain: Option<&str>, mag_hue: Option<&str>, red_gain: Option<&str>, red_hue: Option<&str>, yellow_gain: Option<&str>, yellow_hue: Option<&str>) -> Result<(), Error<BirddogcmsetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogcmsetup_post(configuration: &configuration::Configuration, birddogcmsetup_post_request: models::BirddogcmsetupPostRequest) -> Result<(), Error<BirddogcmsetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogdetsetup_get(configuration: &configuration::Configuration, bandwidth: Option<&str>, bw_balance: Option<&str>, crispening: Option<&str>, detail: Option<&str>, high_light_detail: Option<&str>, hv_balance: Option<&str>, limit: Option<&str>, super_low: Option<&str>) -> Result<(), Error<BirddogdetsetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogdetsetup_post(configuration: &configuration::Configuration, birddogdetsetup_post_request: models::BirddogdetsetupPostRequest) -> Result<(), Error<BirddogdetsetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogexpsetup_post(configuration: &configuration::Configuration, birddogexpsetup_post_request: models::BirddogexpsetupPostRequest) -> Result<(), Error<BirddogexpsetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogexternalsetup_get(configuration: &configuration::Configuration, aux: Option<&str>, rain_wiper: Option<&str>, v12v_out: Option<&str>) -> Result<(), Error<BirddogexternalsetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogexternalsetup_post(configuration: &configuration::Configuration, birddogexternalsetup_post_request: models::BirddogexternalsetupPostRequest) -> Result<(), Error<BirddogexternalsetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddoggammasetup_post(configuration: &configuration::Configuration, birddoggammasetup_post_request: models::BirddoggammasetupPostRequest) -> Result<(), Error<BirddoggammasetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogpicsetup_post(configuration: &configuration::Configuration, birddogpicsetup_post_request: models::BirddogpicsetupPostRequest) -> Result<(), Error<BirddogpicsetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogptzsetup_get(configuration: &configuration::Configuration, pan_speed: Option<&str>, tilt_speed: Option<&str>, zoom_speed: Option<&str>) -> Result<(), Error<BirddogptzsetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogptzsetup_post(configuration: &configuration::Configuration, birddogptzsetup_post_request: models::BirddogptzsetupPostRequest) -> Result<(), Error<BirddogptzsetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogsil2codec_get(configuration: &configuration::Configuration, protocol: Option<&str>, selected_mode: Option<&str>, quant_factor_i: Option<&str>, quant_factor_p: Option<&str>, gop_size: Option<&str>, bitrate: Option<&str>) -> Result<(), Error<Birddogsil2codecGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogsil2codec_post(configuration: &configuration::Configuration, birddogsil2codec_post_request: models::Birddogsil2codecPostRequest) -> Result<(), Error<Birddogsil2codecPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogsil2enc_get(configuration: &configuration::Configuration, streaming_protocol: Option<&str>, port: Option<&str>, stream_name: Option<&str>, auth_enable: Option<&str>, user_name: Option<&str>, password: Option<&str>, ip_address: Option<&str>, mode: Option<&str>, latency: Option<&str>, encryption: Option<&str>, passphrase: Option<&str>, pbkeylen: Option<&str>, streamid: Option<&str>, server_selection: Option<&str>, stream_key_local: Option<&str>, stream_key_remote: Option<&str>, server: Option<&str>, hai_vision_player_support: Option<&str>) -> Result<(), Error<Birddogsil2encGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogsil2enc_post(configuration: &configuration::Configuration, birddogsil2enc_post_request: models::Birddogsil2encPostRequest) -> Result<(), Error<Birddogsil2encPostError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogwbsetup_get(configuration: &configuration::Configuration, bg: Option<&str>, br: Option<&str>, blue_gain: Option<&str>, color_temp: Option<&str>, gb: Option<&str>, gr: Option<&str>, level: Option<&str>, matrix: Option<&str>, offset: Option<&str>, phase: Option<&str>, rb: Option<&str>, rg: Option<&str>, red_gain: Option<&str>, select: Option<&str>, speed: Option<&str>, wb_mode: Option<&str>) -> Result<(), Error<BirddogwbsetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn birddogwbsetup_post(configuration: &configuration::Configuration, birddogwbsetup_post_request: models::BirddogwbsetupPostRequest) -> Result<(), Error<BirddogwbsetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn capture_get(configuration: &configuration::Configuration, ch_num: Option<&str>, status: Option<&str>) -> Result<(), Error<CaptureGetError>> {
    let local_var_configuration = configuration;
...
pub async fn connect_to_get(configuration: &configuration::Configuration, ch_num: Option<&str>, sourcename: Option<&str>, status: Option<&str>) -> Result<(), Error<ConnectToGetError>> {
    let local_var_configuration = configuration;
...
pub async fn connect_to_post(configuration: &configuration::Configuration, connect_to_post_request: models::ConnectToPostRequest) -> Result<(), Error<ConnectToPostError>> {
    let local_var_configuration = configuration;
...
pub async fn decode_transport_get(configuration: &configuration::Configuration, rxpm: Option<&str>) -> Result<(), Error<DecodeTransportGetError>> {
    let local_var_configuration = configuration;
...
pub async fn decode_transport_post(configuration: &configuration::Configuration, decode_transport_post_request: models::DecodeTransportPostRequest) -> Result<(), Error<DecodeTransportPostError>> {
    let local_var_configuration = configuration;
...
pub async fn decodesetup_get(configuration: &configuration::Configuration, ch_num: Option<&str>, color_space: Option<&str>, tally_mode: Option<&str>, screen_saver_mode: Option<&str>, ndi_audio: Option<&str>) -> Result<(), Error<DecodesetupGetError>> {
    let local_var_configuration = configuration;
...
pub async fn decodesetup_post(configuration: &configuration::Configuration, decodesetup_post_request: models::DecodesetupPostRequest) -> Result<(), Error<DecodesetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn decodestatus_get(configuration: &configuration::Configuration, ch_num: Option<&str>) -> Result<(), Error<DecodestatusGetError>> {
    let local_var_configuration = configuration;
...
pub async fn encode_transport_get(configuration: &configuration::Configuration, txpm: Option<&str>, txnetprefix: Option<&str>, txnetmask: Option<&str>, txmcttl: Option<&str>) -> Result<(), Error<EncodeTransportGetError>> {
    let local_var_configuration = configuration;
...
pub async fn encode_transport_post(configuration: &configuration::Configuration, encode_transport_post_request: models::EncodeTransportPostRequest) -> Result<(), Error<EncodeTransportPostError>> {
    let local_var_configuration = configuration;
...
pub async fn encodesetup_post(configuration: &configuration::Configuration, encodesetup_post_request: models::EncodesetupPostRequest) -> Result<(), Error<EncodesetupPostError>> {
    let local_var_configuration = configuration;
...
pub async fn hostname_get(configuration: &configuration::Configuration, ) -> Result<(), Error<HostnameGetError>> {
    let local_var_configuration = configuration;
...
pub async fn list_get(configuration: &configuration::Configuration, ) -> Result<(), Error<ListGetError>> {
    let local_var_configuration = configuration;
...
pub async fn n_di_dis_server_get(configuration: &configuration::Configuration, ndi_dis_serv: Option<&str>, ndi_dis_serv_ip: Option<&str>) -> Result<(), Error<NDiDisServerGetError>> {
    let local_var_configuration = configuration;
...
pub async fn n_di_dis_server_post(configuration: &configuration::Configuration, ndi_dis_server_post_request: models::NdiDisServerPostRequest) -> Result<(), Error<NDiDisServerPostError>> {
    let local_var_configuration = configuration;
...
pub async fn n_di_grp_name_get(configuration: &configuration::Configuration, ) -> Result<(), Error<NDiGrpNameGetError>> {
    let local_var_configuration = configuration;
...
pub async fn n_di_grp_name_post(configuration: &configuration::Configuration, body: &str) -> Result<(), Error<NDiGrpNamePostError>> {
    let local_var_configuration = configuration;
...
pub async fn n_di_off_sn_src_get(configuration: &configuration::Configuration, ) -> Result<(), Error<NDiOffSnSrcGetError>> {
    let local_var_configuration = configuration;
...
pub async fn n_di_off_sn_src_post(configuration: &configuration::Configuration, body: &str) -> Result<(), Error<NDiOffSnSrcPostError>> {
    let local_var_configuration = configuration;
...
pub async fn operationmode_get(configuration: &configuration::Configuration, mode: Option<&str>) -> Result<(), Error<OperationmodeGetError>> {
    let local_var_configuration = configuration;
...
pub async fn operationmode_post(configuration: &configuration::Configuration, body: &str) -> Result<(), Error<OperationmodePostError>> {
    let local_var_configuration = configuration;
...
pub async fn reboot_get(configuration: &configuration::Configuration, ) -> Result<(), Error<RebootGetError>> {
    let local_var_configuration = configuration;
...
pub async fn reboot_post(configuration: &configuration::Configuration, ) -> Result<(), Error<RebootPostError>> {
    let local_var_configuration = configuration;
...
pub async fn recall_post(configuration: &configuration::Configuration, recall_post_request: models::RecallPostRequest) -> Result<(), Error<RecallPostError>> {
    let local_var_configuration = configuration;
...
pub async fn refresh_get(configuration: &configuration::Configuration, ) -> Result<(), Error<RefreshGetError>> {
    let local_var_configuration = configuration;
...
pub async fn refresh_post(configuration: &configuration::Configuration, ) -> Result<(), Error<RefreshPostError>> {
    let local_var_configuration = configuration;
...
pub async fn reset_get(configuration: &configuration::Configuration, ) -> Result<(), Error<ResetGetError>> {
    let local_var_configuration = configuration;
...
pub async fn reset_post(configuration: &configuration::Configuration, ) -> Result<(), Error<ResetPostError>> {
    let local_var_configuration = configuration;
...
pub async fn restart_get(configuration: &configuration::Configuration, ) -> Result<(), Error<RestartGetError>> {
    let local_var_configuration = configuration;
...
pub async fn restart_post(configuration: &configuration::Configuration, ) -> Result<(), Error<RestartPostError>> {
    let local_var_configuration = configuration;
...
pub async fn save_post(configuration: &configuration::Configuration, recall_post_request: models::RecallPostRequest) -> Result<(), Error<SavePostError>> {
    let local_var_configuration = configuration;
...
pub async fn videooutputinterface_get(configuration: &configuration::Configuration, videooutput: Option<&str>) -> Result<(), Error<VideooutputinterfaceGetError>> {
    let local_var_configuration = configuration;
...
pub async fn videooutputinterface_post(configuration: &configuration::Configuration, body: &str) -> Result<(), Error<VideooutputinterfacePostError>> {
    let local_var_configuration = configuration;
