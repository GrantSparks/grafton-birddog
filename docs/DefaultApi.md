...
[**connect_to_post**](DefaultApi.md#connect_to_post) | **POST** /connectTo | Connect to NDI Source
...
[**videooutputinterface_get**](DefaultApi.md#videooutputinterface_get) | **GET** /videooutputinterface | Retrieve current videooutputinterface mode of your BirdDog device (sdi/hdmi) or (LowLatency/NormalMode)
[**videooutputinterface_post**](DefaultApi.md#videooutputinterface_post) | **POST** /videooutputinterface | Set base videooutputinterface mode of your BirdDog device



## about_get

> about_get(firmware_version)
...
> analogaudiosetup_get(analog_audio_in_gain, analog_audio_out_gain, analog_audiooutputselect)
...
> analogaudiosetup_post(analogaudiosetup_post_request)
Set Audio Settings
...
> birddogadvancesetup_get(brightness, brightness_comp, comp_level, gamma_offset, high_resolution, video_enhancement)
...
> birddogadvancesetup_post(birddogadvancesetup_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogadvancesetup_post_request** | [**BirddogadvancesetupPostRequest**](BirddogadvancesetupPostRequest.md) |  | [required] |
...
> birddogcmsetup_get(blue_gain, blue_hue, colour_gain, cyan_gain, cyan_hue, green_gain, green_hue, hue_phase, mag_gain, mag_hue, red_gain, red_hue, yellow_gain, yellow_hue)
...
> birddogcmsetup_post(birddogcmsetup_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogcmsetup_post_request** | [**BirddogcmsetupPostRequest**](BirddogcmsetupPostRequest.md) |  | [required] |
...
> birddogdetsetup_get(bandwidth, bw_balance, crispening, detail, high_light_detail, hv_balance, limit, super_low)
...
> birddogdetsetup_post(birddogdetsetup_post_request)
Set Detail Settings
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogdetsetup_post_request** | [**BirddogdetsetupPostRequest**](BirddogdetsetupPostRequest.md) |  | [required] |
...
**shutter_speed_overwrite** | Option<**String**> | Range(30 - 110) |  |
...
> birddogexpsetup_post(birddogexpsetup_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogexpsetup_post_request** | [**BirddogexpsetupPostRequest**](BirddogexpsetupPostRequest.md) |  | [required] |
...
> birddogexternalsetup_get(aux, rain_wiper, v12v_out)
...
> birddogexternalsetup_post(birddogexternalsetup_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogexternalsetup_post_request** | [**BirddogexternalsetupPostRequest**](BirddogexternalsetupPostRequest.md) |  | [required] |
...
> birddoggammasetup_get(black_gamma_level, black_level, black_level_range, effect, level, offset, pattern, pattern_fine, settings, visibility_enhancer)
...
**pattern_fine** | Option<**String**> | Range (0 to9) |  |
...
> birddoggammasetup_post(birddoggammasetup_post_request)
Set Gamma Settings
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddoggammasetup_post_request** | [**BirddoggammasetupPostRequest**](BirddoggammasetupPostRequest.md) |  | [required] |
...
> birddogpicsetup_get(back_light_com, chrome_suppress, color, contrast, effect, flip, gamma, highlight_comp, highlight_comp_mask, hue, ir_cut_filter, mirror, noise_reduction, sharpness, stabilizer, twodnr, three_dnr, wide_dynamic_range, low_latency, nd_filter)
...
> birddogpicsetup_post(birddogpicsetup_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogpicsetup_post_request** | [**BirddogpicsetupPostRequest**](BirddogpicsetupPostRequest.md) |  | [required] |
...
> birddogptzsetup_get(pan_speed, tilt_speed, zoom_speed)
...
> birddogptzsetup_post(birddogptzsetup_post_request)
Set PTZ Settings
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogptzsetup_post_request** | [**BirddogptzsetupPostRequest**](BirddogptzsetupPostRequest.md) |  | [required] |
...
> birddogsil2codec_get(protocol, selected_mode, quant_factor_i, quant_factor_p, gop_size, bitrate)
...
> birddogsil2codec_post(birddogsil2codec_post_request)
...
> birddogsil2enc_get(streaming_protocol, port, stream_name, auth_enable, user_name, password, ip_address, mode, latency, encryption, passphrase, pbkeylen, streamid, server_selection, stream_key_local, stream_key_remote, server, hai_vision_player_support)
...
**port** | Option<**String**> | RTSP or SRT Port |  |
**stream_name** | Option<**String**> | RTSP Stream Name |  |
**auth_enable** | Option<**String**> | true / false |  |
...
**streamid** | Option<**String**> | upto 512 |  |
...
> birddogsil2enc_post(birddogsil2enc_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogsil2enc_post_request** | [**Birddogsil2encPostRequest**](Birddogsil2encPostRequest.md) |  | [required] |
...
> birddogwbsetup_get(bg, br, blue_gain, color_temp, gb, gr, level, matrix, offset, phase, rb, rg, red_gain, select, speed, wb_mode)
...
> birddogwbsetup_post(birddogwbsetup_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**birddogwbsetup_post_request** | [**BirddogwbsetupPostRequest**](BirddogwbsetupPostRequest.md) |  | [required] |
...
> connect_to_get(ch_num, sourcename, status)
...
> connect_to_post(connect_to_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**connect_to_post_request** | [**ConnectToPostRequest**](ConnectToPostRequest.md) |  | [required] |
...
> decode_transport_post(decode_transport_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**decode_transport_post_request** | [**DecodeTransportPostRequest**](DecodeTransportPostRequest.md) |  | [required] |
...
> decodesetup_get(ch_num, color_space, tally_mode, screen_saver_mode, ndi_audio)
...
> decodesetup_post(decodesetup_post_request)
Set Decode Settings
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**decodesetup_post_request** | [**DecodesetupPostRequest**](DecodesetupPostRequest.md) |  | [required] |
...
> encode_transport_get(txpm, txnetprefix, txnetmask, txmcttl)
...
> encode_transport_post(encode_transport_post_request)
Set NDI Network Settings
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**encode_transport_post_request** | [**EncodeTransportPostRequest**](EncodeTransportPostRequest.md) |  | [required] |
...
> encodesetup_get(ch_num, video_format, video_sample_rate, color_bit_depth, stream_name, ndi_audio, screen_saver_mode, bandwidth_mode, bandwidth_select, loop_tally, tally_mode, video_csc, ndi_group, ndi_group_name)
...
> encodesetup_post(encodesetup_post_request)
Set Encode Settings
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**encodesetup_post_request** | [**EncodesetupPostRequest**](EncodesetupPostRequest.md) |  | [required] |
...
> n_di_dis_server_get(ndi_dis_serv, ndi_dis_serv_ip)
...
> n_di_dis_server_post(ndi_dis_server_post_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**ndi_dis_server_post_request** | [**NdiDisServerPostRequest**](NdiDisServerPostRequest.md) |  | [required] |
...
> recall_post(recall_post_request)
Recall Preset
...
> videooutputinterface_get(videooutput)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**videooutput** | Option<**String**> | Device videooutput mode `sdi` `hdmi` `LowLatency` `NormalMode` |  |
...
> videooutputinterface_post(body)
